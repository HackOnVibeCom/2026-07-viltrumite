                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full glass bg-card border border-border/40 focus:border-primary/60 outline-none rounded-xl px-4 py-2.5 text-sm text-foreground"
                        value={appName}
                        ...
                        <div className="flex gap-1 overflow-x-auto pb-1 scrollbar-none">
                          {EMOJIS.map((e) => (
                            <button
                              ...
                              className={`h-8 w-8 rounded-lg text-sm grid place-items-center transition-all cursor-pointer ${appIcon === e ? "bg-primary/20 border border-primary/50" : "glass hover:bg-card"}`}
                            >
                              {e}
                            </button>
                          ))}
                ...
                <div className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full glass bg-card border border-border/40 focus:border-primary/60 outline-none rounded-xl px-4 py-2 text-sm text-foreground resize-none"
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {[
                        ...
                        <button
                          ...
                          className={`rounded-xl p-3 border text-left cursor-pointer transition-all flex flex-col gap-2 ${banner === g.gradient ? "border-primary bg-primary/10 shadow-glow" : "border-border/40 glass hover:bg-card"}`}
                        >
        ...
        <div className="p-6 border-t border-border/40 bg-surface/40 flex items-center justify-between">
          ...
          {step < 6 ? (
            <button
              type="button"
              onClick={nextStep}
              className="flex items-center gap-1.5 px-5 py-2 rounded-xl text-xs font-semibold text-foreground bg-primary hover:bg-primary/95 cursor-pointer transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-6 py-2.5 rounded-xl text-xs font-bold text-foreground animated-gradient cursor-pointer hover:scale-[1.02] transition-transform"
