...
import { 
  ...
  Award, Twitter, Globe, Send, Loader2
} from "lucide-react";
      ...
      <div className="p-6 md:p-8 max-w-4xl">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">AI Launch Copilot</h1>
        ...
        >
          ...
          <h2 className="text-xl font-bold mb-2 text-foreground">No Product Launched Yet</h2>
      ...
      <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex bg-border/40 p-1 rounded-xl w-fit">
          <button 
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition cursor-pointer ${activeTab === "aso" ? "bg-primary text-white" : "text-muted-foreground hover:text-foreground"}`}
          >
            ASO Audit
          </button>
          <button 
            onClick={() => setActiveTab("kit")}
            className={`px-4 py-2 rounded-lg text-sm font-medium transition cursor-pointer ${activeTab === "kit" ? "bg-primary text-white" : "text-muted-foreground hover:text-foreground"}`}
          >
            Launch Kit
          </button>
        </div>
      ...
      <AnimatePresence mode="wait">
        {activeTab === "aso" ? (
          ...
          >
            ...
            {asoReport && (
              <div className="grid md:grid-cols-[200px_1fr] gap-6 glass-strong rounded-3xl p-6 border border-border/50">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-bold text-foreground">ASO Audit Summary</h3>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
                    {Object.entries(asoReport.fieldStats).map(([field, stat]: any) => (
                      <div key={field} className="glass rounded-xl p-3 border border-border/40">
                        ...
                        <div className="text-sm font-bold mt-1 text-foreground">{stat.used} chars</div>
            ...
            {/* Findings list */}
            <div className="space-y-4">
              <h2 className="text-lg font-bold text-foreground">Audit Violations & Recommendations</h2>
            ...
            {!launchKit ? (
              <div className="glass-strong rounded-3xl border border-primary/20 p-8 text-center space-y-6">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-bold text-foreground">Generate Custom Launch Kit</h3>
                ...
                <button 
                  onClick={generateKit}
                  disabled={loading}
                  className="px-6 py-3 rounded-xl bg-primary hover:bg-primary/95 text-white font-semibold flex items-center gap-2 mx-auto disabled:opacity-50 transition cursor-pointer"
                >
                  {loading ? (
                    <>
                ...
                <div className="flex flex-col gap-2 bg-border/20 p-2 rounded-2xl h-fit">
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-left text-sm font-medium transition cursor-pointer ${
                  ...
                  <div className="border-t border-border/40 my-1 pt-1">
                    <button
                      ...
                      className="w-full text-center py-2 text-xs text-red-400 hover:bg-red-500/10 rounded-xl transition cursor-pointer"
                    >
                      Reset & Regenerate
                    </button>
                  </div>
                ...
                <div className="glass rounded-3xl p-6 border border-border/50 min-h-[300px]">
                  {kitTab === "aso_opt" && (
                    <div className="space-y-5">
                      <h3 className="text-lg font-bold border-b border-border/60 pb-3 flex items-center gap-2 text-foreground">
                      ...
                      <div className="space-y-4">
                        <div className="space-y-1">
                          ...
                          <div className="p-3 bg-black/20 border border-border/40 rounded-xl flex items-center justify-between">
                            <span className="font-semibold text-sm text-foreground">{launchKit.aso.title}</span>
                            <button onClick={() => handleCopy(launchKit.aso.title, "aso_title")} className="text-muted-foreground hover:text-primary transition cursor-pointer">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="p-3 bg-black/20 border border-border/40 rounded-xl flex items-center justify-between">
                            <span className="font-semibold text-sm text-foreground">{launchKit.aso.subtitle}</span>
                            <button onClick={() => handleCopy(launchKit.aso.subtitle, "aso_sub")} className="text-muted-foreground hover:text-primary transition cursor-pointer">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="p-4 bg-black/20 border border-border/40 rounded-xl relative">
                            <button onClick={() => handleCopy(launchKit.aso.description, "aso_desc")} className="absolute top-3 right-3 text-muted-foreground hover:text-primary transition cursor-pointer">
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="space-y-4">
                        <div className="space-y-1">
                          ...
                          <div className="p-3 bg-black/20 border border-border/40 rounded-xl flex items-center justify-between">
                            <span className="font-semibold text-sm text-foreground">{launchKit.productHunt.tagline}</span>
                            <button onClick={() => handleCopy(launchKit.productHunt.tagline, "ph_tag")} className="text-muted-foreground hover:text-primary transition cursor-pointer">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="p-3 bg-black/20 border border-border/40 rounded-xl flex items-center justify-between">
                            ...
                            <button onClick={() => handleCopy(launchKit.productHunt.description, "ph_desc")} className="text-muted-foreground hover:text-primary transition shrink-0 ml-4 cursor-pointer">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="p-4 bg-black/20 border border-border/40 rounded-xl relative">
                            <button onClick={() => handleCopy(launchKit.productHunt.firstComment, "ph_comment")} className="absolute top-3 right-3 text-muted-foreground hover:text-primary transition cursor-pointer">
                  ...
                  {kitTab === "social" && (
                    <div className="space-y-5">
                      ...
                      <div className="space-y-4 max-h-[450px] overflow-y-auto pr-2" data-lenis-prevent="true">
                        {launchKit.social.map((item: any, idx: number) => (
                          <div key={idx} className="p-4 bg-black/20 border border-border/40 rounded-xl space-y-2 relative">
                            <button onClick={() => handleCopy(item.post + " " + item.hashtags.join(" "), `soc_${idx}`)} className="absolute top-4 right-4 text-muted-foreground hover:text-primary transition cursor-pointer">
                            ...
                            <p className="text-sm text-muted-foreground leading-relaxed pr-6">{item.post}</p>
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="space-y-4">
                        <div className="space-y-1">
                          ...
                          <div className="p-3 bg-black/20 border border-border/40 rounded-xl flex items-center justify-between">
                            <span className="font-semibold text-sm text-foreground">{launchKit.press.coldEmail.subject}</span>
                            <button onClick={() => handleCopy(launchKit.press.coldEmail.subject, "email_sub")} className="text-muted-foreground hover:text-primary transition cursor-pointer">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="p-4 bg-black/20 border border-border/40 rounded-xl relative">
                            <button onClick={() => handleCopy(launchKit.press.coldEmail.body, "email_body")} className="absolute top-3 right-3 text-muted-foreground hover:text-primary transition cursor-pointer">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="space-y-1">
                            ...
                            <div className="p-3 bg-black/20 border border-border/40 rounded-xl relative min-h-[100px]">
                              <button onClick={() => handleCopy(launchKit.press.blurb50, "blurb_50")} className="absolute top-3 right-3 text-muted-foreground hover:text-primary transition cursor-pointer">
                          ...
                          <div className="space-y-1">
                            ...
                            <div className="p-3 bg-black/20 border border-border/40 rounded-xl relative min-h-[100px]">
                              <button onClick={() => handleCopy(launchKit.press.blurb100, "blurb_100")} className="absolute top-3 right-3 text-muted-foreground hover:text-primary transition cursor-pointer">
